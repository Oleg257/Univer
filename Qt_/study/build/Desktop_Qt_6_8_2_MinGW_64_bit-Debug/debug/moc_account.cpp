...
static constexpr auto qt_meta_stringdata_ZN7AccountE = QtMocHelpers::stringData(
    "Account",
...
Q_CONSTINIT static const uint qt_meta_data_ZN7AccountE[] = {
...
Q_CONSTINIT const QMetaObject Account::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7AccountE.offsetsAndSizes,
    qt_meta_data_ZN7AccountE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7AccountE_t,
        // Q_OBJECT / Q_GADGET
...
void *Account::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7AccountE.stringdata0))
