...
namespace {
struct qt_meta_tag_ZN9MaterialsE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN9MaterialsE = QtMocHelpers::stringData(
    "Materials"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9MaterialsE[] = {
...
Q_CONSTINIT const QMetaObject Materials::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9MaterialsE.offsetsAndSizes,
    qt_meta_data_ZN9MaterialsE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9MaterialsE_t,
        // Q_OBJECT / Q_GADGET
...
void *Materials::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9MaterialsE.stringdata0))
