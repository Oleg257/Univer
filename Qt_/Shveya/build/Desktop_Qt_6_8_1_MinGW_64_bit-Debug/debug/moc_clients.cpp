...
namespace {
struct qt_meta_tag_ZN7ClientsE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN7ClientsE = QtMocHelpers::stringData(
    "Clients"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7ClientsE[] = {
...
Q_CONSTINIT const QMetaObject Clients::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7ClientsE.offsetsAndSizes,
    qt_meta_data_ZN7ClientsE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7ClientsE_t,
        // Q_OBJECT / Q_GADGET
...
void *Clients::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7ClientsE.stringdata0))
